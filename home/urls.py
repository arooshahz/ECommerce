...
urlpatterns = [
    ...
    path('cart/<slug:slug>', views.ViewOrder.as_view(), name='cart'),
    path('cart/all/done', views.CartDoneView.as_view(), name='cart_done'),
    path('cart/all/completion', views.CartCompletionView.as_view(), name='cart_info'),
